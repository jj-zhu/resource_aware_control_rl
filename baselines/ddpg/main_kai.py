...
import baselines.ddpg.training_kai as training_kai
from baselines.ddpg.models_kai import Actor_kai, Critic_kai
...
def run(env_id, seed, noise_type, layer_norm, evaluation, **kwargs):
    ...
    critic = Critic_kai(layer_norm=layer_norm)
    actor = Actor_kai(nb_actions, layer_norm=layer_norm)
    ...
    training_kai.train(env_id = env_id, env=env, eval_env=eval_env, param_noise=param_noise,
